  ...
  <div ref="rootRef" class="bg-cream-50 dark:bg-charcoal-900">
    ...
    <section class="section-container py-20 lg:py-28">
      <div class="grid items-start gap-8 lg:grid-cols-12">
        ...
        <div data-reveal class="lg:col-span-8">
          <div class="overflow-hidden border border-charcoal-100 dark:border-charcoal-700">
            <img
              :src="movizeCase.v1Image"
              alt=""
    ...
    <section class="cs-modules section-container py-16 lg:py-24">
      <div class="relative pl-8 lg:pl-12">
        <span
          class="cs-modules-line absolute left-0 top-2 h-[calc(100%-1rem)] w-0.5 origin-top bg-turquoise/30"
          aria-hidden="true"
        />
        <div
        ...
        >
          <span
            class="absolute -left-[calc(2rem+5px)] top-2 h-2.5 w-2.5 bg-turquoise lg:-left-[calc(3rem+5px)]"
            aria-hidden="true"
          />
